...
def Streamlines(P, i_max, j_max):
    ...
    strm = ax.streamplot(X, Y, U, V , color='lightblue', density=2.0, arrowstyle='->', arrowsize=1.5)
    ...
    pressure_contour_filled = ax.contourf(X, Y, P_array, levels=200, cmap=cm.cool, alpha=0.9)
