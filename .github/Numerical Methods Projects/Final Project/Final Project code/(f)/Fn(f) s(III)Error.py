...
def GeneralSHow(x_len,y_len, size, Kmax):
...
def eploting2( e32, e64, e96, e160, e192, e224):
    import matplotlib.pyplot as plt
    import math

    # 假设这是您的四个坐标点
    x1, y1 = math.log(32), math.log(e32)
    x2, y2 = math.log(96), math.log(e96)
    x3, y3 = math.log(160), math.log(e160)
    x4, y4 = math.log(224), math.log(e224)
    x5, y5 = math.log(64), math.log(e64)
    x6, y6 = math.log(192), math.log(e192)
    ...
    # 定义四个点的坐标
    x = np.array([x2, x3, x4, x5, x6])
    y = np.array([y2, y3, y4, y5, y6])

    # 进行线性回归，得到拟合直线的参数
    parameters = np.polyfit(x, y, 1)  # 1 表示一次多项式，即直线
    ...
    # 绘制点和拟合直线
    plt.scatter(x, y, marker='o',color='#ef8a62')  # 绘制点
    plt.plot(x, fit_line, color='#67a9cf')  # 绘制拟合直线
...
def main():
    ...
    e1 = GeneralSHow(x_len,y_len, size, Kmax)
    ...
    e32 = GeneralSHow(x_len,y_len, size, Kmax)
    ...
    e64 = GeneralSHow(x_len,y_len, size, Kmax)
    ...
    e96 = GeneralSHow(x_len,y_len, size, Kmax)
    ...
    e160 = GeneralSHow(x_len,y_len, size, Kmax)
    ...
    e192 = GeneralSHow(x_len,y_len, size, Kmax)
    ...
    e224 = GeneralSHow(x_len,y_len, size, Kmax)


    '''

    e = [0 in range(32, 223, 16)]
    for size in range(32, 224, 16):
        d = len/size


        e[size] = Generaleach(x_len,y_len,d,r,x_c,y_c, Kmax, w)
    ...
    eploting2(e32[Kmax], e64[Kmax], e96[Kmax], e192[Kmax], e160[Kmax], e224[Kmax])
