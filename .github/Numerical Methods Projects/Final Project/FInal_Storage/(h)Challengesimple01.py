...
def Large_transfer(F, P, n, j_max, i_max):
    j_C0 = int(((n-1)/2)*j_max)
    i_C0 = int(((n-1)/2)*i_max)
    for j in range(0,j_max):
        for i in range(0,i_max):
            P[j_C0+j][i_C0+i] = F[j][i]
...
def main():
    ...
    C_inner = Large_transfer(C_inner, Pin, n, j_max, i_max)
    C_total = Large_transfer(C_total, Pin, n, j_max, i_max)
    C_xbl = Large_transfer(C_xbl, Pin, n, j_max, i_max)
    C_xbh = Large_transfer(C_xbh, Pin, n, j_max, i_max)
    C_ybl = Large_transfer(C_ybl, Pin, n, j_max, i_max)
    C_ybh = Large_transfer(C_ybh, Pin, n, j_max, i_max)
    C_edge = Large_transfer(C_edge, Pin, n, j_max, i_max)
    C_xlyl = Large_transfer(C_xlyl, Pin, n, j_max, i_max)
    C_xlyh = Large_transfer(C_xlyh, Pin, n, j_max, i_max)
    C_xhyl = Large_transfer(C_xhyl, Pin, n, j_max, i_max)
    C_xhyh = Large_transfer(C_xhyh, Pin, n, j_max, i_max)
