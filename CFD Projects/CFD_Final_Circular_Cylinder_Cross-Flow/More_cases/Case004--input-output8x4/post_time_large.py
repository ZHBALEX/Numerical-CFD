...
def main():
    ...
    data_re, u_0, v_0, U_0, V_0 , \
        u_old_0, v_old_0, U_old_0, V_old_0,  p \
            = Recover_result(filename = 'result/save/output_N32.0_Re=150.0_t=1.0_8.0x4.0222.txt')
    ...
    for n in range(1,101):
        ...
        data_re, u_0, v_0, U_0, V_0 , \
        u_old_0, v_old_0, U_old_0, V_old_0,  p \
            = Recover_result(filename = 'result/save/output_N32.0_Re=150.0_t=%.1f_8.0x4.0222.txt'%time)
